...
Here's a [list of *terminology* and a list of *useful slurm commands*](exacloud_tutorial/reference/). If you get confused by any terms, please refer to it.
...
Remember: be a good exacloud citizen, since it's a shared resource. [Take the pledge](exacloud_tutorial/pledge/).
