...
+ How to get information about jobs using `squeue`
...
You can see the profile information for everything we did in the interactive session. Pay attention to NCPUS (the number of CPUS actually used), Elapsed, and MaxVMSize. When you request a batch job (below), you will use these numbers to request resources.
