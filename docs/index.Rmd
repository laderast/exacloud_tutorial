...
We're going to run `samtools` on a small bam file. `samtools` is located here: 
...
2. Let's use `srun` to run `samtools`:

```
/opt/installed/samtools-1.6/bin/samtools sort 1.1-1000000.NA06984.454.MOSAIK.SRP000033.2009_11.bam
